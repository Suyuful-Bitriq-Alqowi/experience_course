    ...
    <section class="bg-blue-50 py-16">
        <div class="container mx-auto text-center">
            ...
            <div class="flex flex-wrap justify-center gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm">
                    <img src="https://i.pinimg.com/736x/e0/5a/46/e05a467e9af0d3dc9e3b95273e481c6c.jpg" alt="Rayhan FR" class="h-16 w-16 rounded-full mx-auto mb-4">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm">
                    <img src="https://i.pinimg.com/736x/ac/77/2c/ac772cd709336c8b9bcaf19bc280c293.jpg" alt="Yusuf Mubrikz" class="h-16 w-16 rounded-full mx-auto mb-4">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm">
                    <img src="https://i.pinimg.com/736x/a0/5b/82/a05b822d710b155987cbf666e7608a93.jpg" alt="Andhika Eka" class="h-16 w-16 rounded-full mx-auto mb-4">
        ...
        <div class="container mx-auto text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
                    <img src="https://awsimages.detik.net.id/visual/2024/06/06/presiden-dan-ceo-nvidia-corporation-jensen-huang-menyampaikan-pidato-saat-pameran-computex-2024-di-taipei-taiwan-minggu-2-juni-2_169.jpeg?w=650" alt="AI and Banks" class="mx-auto mb-4 rounded-lg h-48 w-full object-cover">
                ...
                <!-- News Example 2 -->
                <div class="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
                    <img src="https://img.pikbest.com/origin/10/10/69/922pIkbEsT3nB.jpg!w700wp" alt="AI and Banks" class="mx-auto mb-4 rounded-lg h-48 w-full object-cover">
                ...
                <!-- News Example 3 -->
                <div class="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
                    <img src="https://asset.kompas.com/crops/x8oHk94oVvYb0QTBqtSeWaBe9tc=/0x0:0x0/1200x800/data/photo/2024/06/23/6677e2e6425e4.jpeg" alt="Coding for Kids" class="mx-auto mb-4 rounded-lg h-48 w-full object-cover">
